...
public class StringMethods {
     ...
     * @param beginChar The last set of characters(originally a character, but it
    ...
    /**
     * @param s       The String to cut
     * @param endChar The last set of characters(originally a character, but it
    ...
    /**
     * @param base        - The String to work with
