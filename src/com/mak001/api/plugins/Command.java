...
public class Command {
     ...
     *
     * @param plugin        - The plugin that made the command
     * @param command       - The command
     * @param commandAction - This determines what the command will do when called
     */
     ...
     *
     * @param plugin        - The plugin that made the command
     * @param command       - The command and aliases
     * @param commandAction - This determines what the command will do when called
     */
    public Command(Plugin plugin, String[] command, CommandAction commandAction) {
     ...
     * @param plugin        - The plugin that made the command
     * @param command       - The command
     * @param permission    - The permission node required to use the command
     * @param commandAction - This determines what the command will do when called
     */
     ...
     * @param login    - The login of the sender of the command
     * @param hostname - The host name of the sender of the command
     */
     ...
     * the help data
     *
     * @param channel  - The channel the command was sent to [same as sender if its in a PM]
     * @param sender   - The sender of the command
     * @param login    - The login of the sender of the command
     * @param hostname - The host name of the sender of the command
     */
    ...
    public interface CommandAction {
         ...
         * @param login      - The login of the sender of the command
         * @param hostname   - The host name of the sender of the command
         * @param additional - Any arguments (make sure to handle invalid ones, because
         *                   people are idiots)
         */
        public void onCommand(String channel, String sender, String login, String hostname, String additional);
